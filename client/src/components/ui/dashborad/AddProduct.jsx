...
function AddProduct() {
  ...
  const { categories, isLoading: isCategoriesLoading } = useCategoryFilter();
  ...
  return (
    <div>
      <div className="min-h-screen bg-[#FFFBEE] py-10">
        {/* main heading */}
        ...
        <div className="bg-white border w-full md:w-[95%] mx-auto border-gray-200 shadow-md rounded-2xl">
          <form className="p-6 w-full" onSubmit={handleSubmit}>
            ...
            <div className="flex justify-center mt-6">
              <Button
                className="bg-primary w-[50%] px-6 py-3 hover:bg-white hover:border text-white hover:text-black hover:cursor-pointer"
                type="submit"
              >
